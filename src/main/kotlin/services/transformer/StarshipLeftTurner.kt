...
class StarshipLeftTurner(private val id: String) : Transformer {
    ...
    override fun transform(gameService: GameService): GameService {
        ...
        return gameService.copy(starships = pick.first + listOf(pick.second.turnLeft()), keyMapHandler = gameService.keyMapHandler)
    }
}
