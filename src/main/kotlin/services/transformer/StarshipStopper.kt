...
class StarshipStopper(private val id: String) : Transformer {
    ...
    override fun transform(gameService: GameService): GameService {
        ...
        return gameService.copy(starships = pick.first + listOf(pick.second.stop()), keyMapHandler = gameService.keyMapHandler)
    }
}
